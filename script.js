...
$(window).keydown(function(e) {
    if (e.which == 32) {return;    // do nothing when spacebar
    }
...
let player = new Shooter( getTopLeft(document.getElementById("hitbox_player")).x,
getTopLeft(document.getElementById("hitbox_player")).y,  'red',  10);
